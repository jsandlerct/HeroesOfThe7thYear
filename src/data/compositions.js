...
export const ENEMY_COMPOSITIONS = {
  ...
  5: [
    ...
    // -- Year 5 / Option B
    {
      left:   [{ type: 'orc', count: 18 }, { type: 'ogre', count: 1 }, { type: 'catapult', count: 1 }],
      center:   [{ type: 'goblin', count: 10 }, { type: 'general', count: 1 }],
    ...
    // -- Year 5 / Option C
    {
      ...
      center:   [{ type: 'goblin', count: 8 }, { type: 'ogre', count: 1 }, { type: 'general', count: 1 }, { type: 'catapult', count: 1 }],
  ...
  7: [
    ...
    // -- Year 7 / Option C
    {
      left:   [{ type: 'orc', count: 8 }, { type: 'goblin', count: 5 }],
      center:   [{ type: 'goblin', count: 10 }, { type: 'general', count: 1 }],
      right:   [{ type: 'orc', count: 20 }, { type: 'ogre', count: 2 }, { type: 'general', count: 1 }, { type: 'catapult', count: 1 }],
      reserves: [
        { slot: 'left', units: [{ type: 'goblin', count: 4 }], logic: 'left_after_delay' },
        { slot: 'center', units: [{ type: 'goblin', count: 3 }], logic: 'right_after_delay' },
        { slot: 'right', units: [{ type: 'ogre', count: 1 }, { type: 'orc', count: 4 }], logic: 'right_after_delay' },
  ...
  8: [
    // -- Year 8 / Option A
    {
      ...
      scoutingReport: "A very large force -- orcs, goblins, two ogres, two generals, and a catapult confirmed. Expect sustained siege fire.",
    },
    // -- Year 8 / Option B
    {
    ...
    // -- Year 8 / Option C
    {
      ...
      reserves: [
        ...
        { slot: 'center', units: [{ type: 'ogre', count: 2 }], logic: 'left_after_delay' },
        { slot: 'right', units: [{ type: 'goblin', count: 3 }], logic: 'right_after_delay' },
      ],
      scoutingReport: "Orcs and a massive goblin contingent. Three generals, two ogres, and a catapult spotted in the column.",
    },
  ],
  ...
  9: [
    // -- Year 9 / Option A
    {
      ...
      scoutingReport: "An enormous army. Orcs, goblins, five ogres, four generals, and a catapult. This is a major assault force.",
    },
    // -- Year 9 / Option B
    {
    ...
    // -- Year 9 / Option C
    {
      ...
      center:   [{ type: 'goblin', count: 15 }, { type: 'general', count: 1 }, { type: 'catapult', count: 1 }],
      right:   [{ type: 'orc', count: 25 }, { type: 'ogre', count: 3 }, { type: 'general', count: 2 }, { type: 'catapult', count: 1 }],
      reserves: [
        { slot: 'left', units: [{ type: 'goblin', count: 3 }], logic: 'left_after_delay' },
  ...
  10: [
    // -- Year 10 / Option A
    {
      ...
      scoutingReport: "Everything they have. Enormous orc and goblin numbers, four ogres per flank, five generals, and a catapult. This is their full strength.",
    },
    // -- Year 10 / Option B
    {
